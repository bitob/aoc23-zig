...
pub const __re_size_t = c_uint;
pub const __re_long_size_t = c_ulong;
pub const s_reg_t = c_long;
pub const active_reg_t = c_ulong;
pub const reg_syntax_t = c_ulong;
pub extern var re_syntax_options: reg_syntax_t;
pub const _REG_ENOSYS: c_int = -1;
pub const _REG_NOERROR: c_int = 0;
pub const _REG_NOMATCH: c_int = 1;
pub const _REG_BADPAT: c_int = 2;
pub const _REG_ECOLLATE: c_int = 3;
pub const _REG_ECTYPE: c_int = 4;
pub const _REG_EESCAPE: c_int = 5;
pub const _REG_ESUBREG: c_int = 6;
pub const _REG_EBRACK: c_int = 7;
pub const _REG_EPAREN: c_int = 8;
pub const _REG_EBRACE: c_int = 9;
pub const _REG_BADBR: c_int = 10;
pub const _REG_ERANGE: c_int = 11;
pub const _REG_ESPACE: c_int = 12;
pub const _REG_BADRPT: c_int = 13;
pub const _REG_EEND: c_int = 14;
pub const _REG_ESIZE: c_int = 15;
pub const _REG_ERPAREN: c_int = 16;
pub const reg_errcode_t = c_int;
pub const struct_re_dfa_t = opaque {}; // (no file):30:1: warning: struct demoted to opaque type - has bitfield
...
pub export const sizeof_regex_t: usize = @sizeOf(regex_t);
pub export const alignof_regex_t: usize = @alignOf(regex_t);
pub export fn isMatch(arg_re: ?*regex_t, arg_input: [*c]const u8) bool {
    var re = arg_re;
    var input = arg_input;
    var pmatch: [0]regmatch_t = undefined;
    return regexec(re, input, @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))), @as([*c]regmatch_t, @ptrCast(@alignCast(&pmatch))), @as(c_int, 0)) == @as(c_int, 0);
}
...
pub const __REPB_PREFIX = @compileError("unable to translate macro: undefined identifier `__`"); // /usr/include/regex.h:410:10
pub const _Restrict_ = @compileError("unable to translate macro: undefined identifier `__restrict`"); // /usr/include/regex.h:649:11
pub const alignas = @compileError("unable to translate C expr: unexpected token '_Alignas'"); // /usr/lib/zig/include/stdalign.h:14:9
pub const alignof = @compileError("unable to translate C expr: expected '(' instead got 'Eof'"); // /usr/lib/zig/include/stdalign.h:15:9
...
pub const REG_EXTENDED = @as(c_int, 1);
pub const REG_ICASE = @as(c_int, 1) << @as(c_int, 1);
pub const REG_NEWLINE = @as(c_int, 1) << @as(c_int, 2);
pub const REG_NOSUB = @as(c_int, 1) << @as(c_int, 3);
pub const REG_NOTBOL = @as(c_int, 1);
pub const REG_NOTEOL = @as(c_int, 1) << @as(c_int, 1);
pub const REG_STARTEND = @as(c_int, 1) << @as(c_int, 2);
pub const REG_ENOSYS = _REG_ENOSYS;
pub const REG_NOERROR = _REG_NOERROR;
pub const REG_NOMATCH = _REG_NOMATCH;
pub const REG_BADPAT = _REG_BADPAT;
pub const REG_ECOLLATE = _REG_ECOLLATE;
pub const REG_ECTYPE = _REG_ECTYPE;
pub const REG_EESCAPE = _REG_EESCAPE;
pub const REG_ESUBREG = _REG_ESUBREG;
pub const REG_EBRACK = _REG_EBRACK;
pub const REG_EPAREN = _REG_EPAREN;
pub const REG_EBRACE = _REG_EBRACE;
pub const REG_BADBR = _REG_BADBR;
pub const REG_ERANGE = _REG_ERANGE;
pub const REG_ESPACE = _REG_ESPACE;
pub const REG_BADRPT = _REG_BADRPT;
pub const REG_EEND = _REG_EEND;
pub const REG_ESIZE = _REG_ESIZE;
pub const REG_ERPAREN = _REG_ERPAREN;
pub const __RE_TRANSLATE_TYPE = [*c]u8;
pub inline fn _REGEX_NELTS(n: anytype) @TypeOf(n) {
    return n;
}
pub inline fn _Attr_access_(arg: anytype) @TypeOf(__attr_access(arg)) {
    return __attr_access(arg);
}
pub const _Restrict_arr_ = __restrict_arr;
...
pub const re_dfa_t = struct_re_dfa_t;
